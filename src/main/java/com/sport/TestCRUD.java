...
/**
 * Тестовый класс для проверки CRUD операций через консоль.
 * Запускай его отдельно от Main, чтобы проверить базу данных.
 */
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Team newTeam = new Team.Builder()
                    .name("Test FC " + System.currentTimeMillis())
                    .sport("Football")
                    .coach("Test Coach")
                    .location("Test City")
                    .foundedYear(2024)
            ...
            Player newPlayer = new Player.Builder()
                    ...
                    .position("Forward")
                    .rating(8.5)
                    .teamId(savedTeam.getId()) // Привязываем к ID созданной команды (Integer)
                    .jerseyNumber(99)
                    .build();
            ...
            e.printStackTrace();
            System.err.println("\nCRITICAL ERROR during tests: " + e.getMessage());
        }
        ...
        System.out.println("If you see this message and no errors above, PostgreSQL is working correctly!");
    }
}